...
function readingDataFromLocalStorage(dataEntered) {
  ...
  var d=localStorage.setItem("DOB",dataEntered[1])
  var j = localStorage.setItem("Job", dataEntered[2]);
  var e = localStorage.setItem("Experience", dataEntered[3]);
...
function edit(td) {
  ...
  document.getElementById("job").value = row.cells[2].innerHTML;
  document.getElementById("exp").value = row.cells[3].innerHTML;
}
...
function update(td) {
  ...
  row.cells[1].innerHTML = document.getElementById("dob").value;
  row.cells[2].innerHTML = document.getElementById("job").value;
  row.cells[3].innerHTML = document.getElementById("exp").value;
  row = null;
}
